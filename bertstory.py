...
valData =  createData('dataset/cloze_test_test__spring2016 - cloze_test_ALL_test.csv')
print("Training Data Size: " + len(train_features))
print("Test Data Size: " + len(valData))
