...
train_features = createData('gdrive/My Drive/data/input/cloze_test_val__spring2016 - cloze_test_ALL_val.csv')
...
run_config = tf.estimator.RunConfig(
    model_dir='gdrive/My Drive/data5',
...
!ls 'gdrive/My Drive/data/input'
valfile = 'gdrive/My Drive/data/input/cloze_test_test__spring2016 - cloze_test_ALL_test.csv'
